/* Los mensajes del sistema: el texto vive en la base, no en este archivo.
   ...
   arma el aviso pasa los valores; acá se reemplazan y nada más.
   ...
   la vista, exactamente como hace `src/i18n/faltaLaFrase.js` del lado de las pantallas. Un aviso
   con un hueco mudo sale igual y nadie se entera; uno con la marca se ve. */
...
/* Lo cargado. Una clave, sus tres idiomas del producto, y lo que haya escrito cada Prestadora.
   Es un objeto plano y no una consulta por aviso: un aviso se arma mientras se está mandando un
   correo, y ahí no hay lugar para esperar a la base. */
